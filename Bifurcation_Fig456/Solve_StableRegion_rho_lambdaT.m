...
var_Vec = linspace(0.65,0.8,length_r);    % lambda_T
...
dlmwrite([File_folder_name, 'Bifur_rho_lambdaT_C_2.dat'],C_matrix,' ');
dlmwrite([File_folder_name, 'Bifur_rho_lambdaT_T1_2.dat'],T1_matrix,' ');
