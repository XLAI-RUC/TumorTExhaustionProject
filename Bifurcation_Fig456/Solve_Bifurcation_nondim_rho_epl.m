function Solve_Bifurcation_nondim_rho_epl

epl_0 = 0.03;     % 0.01-0.07
...
File_folder_name = 'output/2D/epl_var/';
dlmwrite([File_folder_name, 'Bifur_epl_0p03_sol1.dat'],RootC1,' ');
dlmwrite([File_folder_name, 'Bifur_epl_0p03_sol2.dat'],RootC2,' ');
dlmwrite([File_folder_name, 'Bifur_epl_0p03_sol3.dat'],RootC3,' ');

end

function Fun = root2d(x,epl_0,rho_0)
