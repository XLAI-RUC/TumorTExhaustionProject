clc; close all; clear all;
    ...
    hf1 = figure;
    %%  %% OS curves 
    load Model_LHS_INFalphaAntiPDL1_25ug_10_20_30_40.mat
    p1 = prcc11(1,:); p1_t = prcc12(1,:);
    p2 = prcc21(1,:); p2_t = prcc22(1,:);
    p3 = prcc31(1,:); p3_t = prcc32(1,:);
    p4 = prcc31(1,:); p4_t = prcc32(1,:);
...
%     subplot(1,2,1), bar(prcc(1,:)); 
%     k = 8;
%     set(gca,'XTickLabel',PRCC_var,'XTick',(1:k))
%     title('PRCCs');
%     subplot(1,2,2),bar(pvalue(1,:));
%     set(gca,'XTickLabel',PRCC_var,'XTick',(1:k))
%     title('p values');
    ...
    print(hf1,'-r700','-dpdf','Fig_LHS_INFalphaAntiPDL1_25ug.pdf');  